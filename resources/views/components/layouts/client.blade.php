    ...
    $navGroups = [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Documents', 'icon' => 'documents', 'url' => route('client.documents.index'), 'active' => request()->routeIs('client.documents.*'), 'badge' => null],
                ['label' => 'Files', 'icon' => 'files', 'url' => route('client.files.index'), 'active' => request()->routeIs('client.files.*'), 'badge' => null],
